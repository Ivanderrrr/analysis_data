...
# Membaca dataset
all_data1 = pd.read_csv('https://raw.githubusercontent.com/Ivanderrrr/analysis_data/main/bike_sharing/dashboard/all_data1.csv')
all_data2 = pd.read_csv('https://raw.githubusercontent.com/Ivanderrrr/analysis_data/main/bike_sharing/dashboard/all_data2.csv')
